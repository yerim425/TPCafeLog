...
class VisitCertifyActivity : AppCompatActivity(), VisitCafeSearchDialogFragment.OnCafeSelectedListener {
    ...
    private var searchCafesJob: Job? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSearchCafe.setOnClickListener {
            VisitCafeSearchDialogFragment(myLocation!!).show(supportFragmentManager, "CafeSearchDialog")
        }
    ...
    override fun onCafeSelected(cafeName: CafeName) {
        binding.tvCafeName.text = cafeName.name
        checkLocation = true
    }
    ...
    fun requestPostVisitCertify(){
        ...
        AlertDialog.Builder(this).setTitle("인증 완료").create().show()
    }
}